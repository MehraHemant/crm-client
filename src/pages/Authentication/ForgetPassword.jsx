...
import { baseURL } from "../../Api/Axios";
  ...
  const ForgetPassword = () => {
    ...
    const handleSubmit = () => {
      axios.post(`${baseURL}/resetPassword`, formData).then(res=>console.log(res.data.msg))
    };
    return (
          ...
          >
            ...
            <Box component={"form"} width={"90%"} display={"grid"} gap={2}>
              ...
              <Box display={"flex"} flexDirection={'column'} alignItems={"center"}>
                <Typography variant="caption">* Kindly Check your email for password reset link.</Typography>
                <Typography
                  component={NavLink}
                  to={"/login"}
                  variant="body2"
